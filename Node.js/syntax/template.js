var name = 'k8805';
var letter = `Lorem Ipsum is simply ${name}


 dummy text of the printing and typesetting industry. ${name}
 
 Lorem Ipsum has been the industry's standard dummy text ${name}
